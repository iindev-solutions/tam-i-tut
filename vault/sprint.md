...
3. Menu translator LIVE (global /scan + venue cache; curated 50-dish dictionary with galleries; long-tail lines get machine-picked photos). Phase B (curation admin) next
